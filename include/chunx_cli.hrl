...
-define(Args_chunx_cli,
        [
         ...
         #{ name => source, help => "source of docs, chunk/beam files (default=all available modules)",
            long => "-source", short => $s, type => {binary, [<<"chunk">>, <<"beam">>]} },
         #{ name => docsources, help => "chunk/beam files",
